...
private:
  ...
  const string paramName[20] = {"LEVEL", "SENS", "Q", "HiF", "LowF", "BOOST"};
  enum paramName {LEVEL, SENS, Q, HIFREQ, LOFREQ, BOOST};
  float param[20] = {1, 1, 1, 1, 1, 1};
  const int16_t paramMax[20] = {100,100, 90, 90, 90,100};
  const int16_t paramMin[20] = {  0,  0, 10, 10, 10,  0};

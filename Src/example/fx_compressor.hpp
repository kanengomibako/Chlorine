...
private:
  ...
  const string paramName[20] = {"LEVEL", "THRE", "RATIO", "ATK", "REL", "KNEE", "BOOST"};
  enum paramName {LEVEL, THRESHOLD, RATIO, ATTACK, RELEASE, KNEE, BOOST};
  float param[20] = {1, 1, 1, 1, 1, 1, 1};
  const int16_t paramMax[20] = {100,  0, 11,100,400, 20,100};
  const int16_t paramMin[20] = {  0,-90,  2,  4,  5,  0,  0};
